...
-- TODO: DDL changes:
-- When the extension is installed, create an event trigger.
-- We have to write it in C so we can see the details of the DDL command.
--   which table
--   which column
--   if it's cascade
-- If it is dropping a parent table with a TRI trigger: ...
-- If it is renaming a parent table with a TRI trigger: ...
-- If it is dropping a parent column with a TRI trigger: ...
-- If it is renaming a parent column with a TRI trigger: ...
-- If it is dropping a child table with a TRI trigger: ...
-- If it is renaming a child table with a TRI trigger: ...
-- If it is dropping a child column with a TRI trigger: ...
-- If it is renaming a child column with a TRI trigger: ...
